...
public class SettingsFragment extends BasePreferenceFragmentCompat implements
    ...
    public static final String THEME_HAS_CHANGED = "com.iota.access.theme_has_changed";

    private static final String INITIAL_THEME = "com.iota.access.initial_theme";
    private static final String SHOW_ADDITIONAL_SETTINGS = "com.iota.access.show_additional_settings";
