...
import org.iota.access.delegation.preview.DelegationPreviewFragment;
...
public class DelegationFragment extends CommunicationFragment<DelegationViewModel> implements
    ...
    private static final String DELEGATION_PREVIEW_FRAGMENT_TAG = "com.iota.access.delegation.preview_fragment";
    private static final String DELEGATION_RULE_FRAGMENT_TAG = "com.iota.access.delegationeditor2.delegation_rule_fragment";
    private static final String USERS_LIST_FRAGMENT_TAG = "com.iota.access.delegationeditor2.users_list_fragment";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i < DelegationViewModel.COST_VALUES.length; ++i) {
            int quantity = (int) (DelegationViewModel.COST_VALUES[i] * Constants.TOKEN_SCALE_FACTOR);
            if (quantity == 0) values[i] = getResources().getString(R.string.free);
            else
                values[i] = getResources().getQuantityString(R.plurals.token_plural, quantity, String.valueOf((int) (DelegationViewModel.COST_VALUES[i] * Constants.TOKEN_SCALE_FACTOR)));
        }
