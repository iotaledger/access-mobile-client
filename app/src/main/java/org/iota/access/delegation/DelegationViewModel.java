...
import org.iota.access.api.model.policy.PolicyAttribute;
import org.iota.access.api.model.policy.PolicyAttributeList;
import org.iota.access.api.model.policy.PolicyAttributeSingle;
import org.iota.access.api.model.policy.PolicyObject;
...
public class DelegationViewModel extends CommunicationViewModel {
    ...
    public static final float[] COST_VALUES = new float[]{0f, 50f / Constants.TOKEN_SCALE_FACTOR, 100f / Constants.TOKEN_SCALE_FACTOR, 150f / Constants.TOKEN_SCALE_FACTOR};
...
//        PolicyAttribute device = createObjectPolicyAttribute(user.getDeviceId());
        ...
        policyGoC.setOperation(PolicyAttributeList.Operation.AND);
...
//            policyGoC.addPolicyAttribute(device);
    ...
    private PolicyAttribute combineRules(List<Rule> ruleList) {
        ...
        policyAttributeList.setOperation(PolicyAttributeList.Operation.AND);
    ...
    private PolicyAttribute createUsersPolicyAttribute(boolean hide) {
        ...
        if (mSelectedUsers.getValue().size() == 1) {
            ...
            singleUser.setOperation(PolicyAttributeList.Operation.EQUAL);
            ...
            finalList.setOperation(PolicyAttributeList.Operation.OR);
    ...
    private PolicyAttribute createObjectPolicyAttribute(final String deviceId) {
        ...
        attributeList.setOperation(PolicyAttributeList.Operation.EQUAL);
    ...
    private PolicyAttribute createActionPolicyAttribute(DelegationAction action) {
        PolicyAttributeList finalList = new PolicyAttributeList();
        finalList.setOperation(PolicyAttributeList.Operation.EQUAL);
